...
class RotationalCipherTest(unittest.TestCase):
    ...
    def test_rotate_punctuation_with_a_high_value_key(self):
        self.assertEqual(
            rotational_cipher.rotate("Let's eat, Grandma!", 151),
            "Gzo'n zvo, Bmviyhv!")
    ...
    def test_rotate_all_letters_in_a_very_long_string_with_a_high_value_rotation_key(self):
        self.assertEqual(
            rotational_cipher.rotate("The quick brown fox jumps"
                                     " over the lazy dog."
                                     " The quick brown fox jumps"
    ...
    def test_correct_arguments_are_accepted(self):
        ...
        with self.assertRaises(ValueError):
            rotational_cipher.rotate(["Text", "to", "put", "through the method"], "24")
