...
class MeetupTest(unittest.TestCase):
    ...
    def test_first_friday_of_february_2019(self):
        self.assertEqual(
            meetup_day(2019, 2, 'Friday', '1st'), date(2019, 2, 1))

    def test_second_monday_of_february_2019(self):
        self.assertEqual(
            meetup_day(2019, 2, 'Monday', '2nd'), date(2019, 2, 11))
