...
class SumOfMultiplesTest(unittest.TestCase):
    ...
    def test_duplicated_multiples_in_multiples_list_are_ignored(self):
        self.assertEqual(sum_of_multiples(51, [5, 25, 25, 5]), 275)
    ...
    def test_sum_of_multiples_only_accept_int_as_limit_argument(self):
        with self.assertRaises(ValueError):
            sum_of_multiples('1000', [2, 5, 10])
    ...
    def test_sum_of_multiples_only_accepts_list_of_ints_as_multiples_argument(self):
        with self.assertRaises(ValueError):
            sum_of_multiples(1000, ['10', '100'])
        with self.assertRaises(ValueError):
            sum_of_multiples(1000, ['ten', 'one hundred'])
